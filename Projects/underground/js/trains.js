...
function load() {
    ...
    if (TrainTimes.map == 'black') {
        ...
        tile_url = 'http://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}.png';
        layer_opts.attribution = '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors';
    }
